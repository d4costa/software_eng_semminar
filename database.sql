...
/*  Created On : 11-ago.-2022 12:01:35 a. m. 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
ALTER TABLE bicycle 
  ADD CONSTRAINT "UK_Chasis" UNIQUE (user_id,chasis_code)
;

ALTER TABLE bicycle ADD CONSTRAINT "CK_id" CHECK (bike_id >0)
;
...
ALTER TABLE checkin_logs ADD CONSTRAINT "CK_log_id" CHECK (log_id > 0)
;
